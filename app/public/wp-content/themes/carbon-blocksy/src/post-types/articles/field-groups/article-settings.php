...
Container::make('post_meta', 'Article Settings')
    ...
    ->add_tab('Community Settings', array(
        Field::make('checkbox', 'community_announcement', 'Show in Community')
            ->set_help_text('Display this article as an announcement in the villa community'),
        ...
        Field::make('date', 'announcement_expires', 'Expiration Date')
            ->set_help_text('Optional: When this announcement should stop showing in the community')
            ->set_conditional_logic(array(
                array(
                    'field' => 'community_announcement',
                    'value' => true,
    ...
    ->add_tab('Article Details', array(
        ...
        Field::make('multiselect', 'target_roles', 'Target Audience')
            ...
            ->set_help_text('Leave empty to show to all community users'),
        Field::make('textarea', 'article_summary', 'Article Summary')
            ->set_help_text('Brief summary for community display (optional - will use excerpt if empty)')
            ->set_rows(3),
    ));
