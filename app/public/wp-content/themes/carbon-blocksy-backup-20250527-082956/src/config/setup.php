...
function crb_load()
{
    ...
    if (file_exists($autoload_path)) {
        ...
        error_log('Carbon Fields loaded successfully');
    } else {
        error_log('Carbon Fields autoload file not found: ' . $autoload_path);
    }
}
...
function carbon_blocks_register_all()
{
    ...
    error_log('Registering blocks from: ' . $blocks_dir);
    ...
    error_log('Found categories: ' . print_r($category_dirs, true));
    ...
    foreach ($category_dirs as $category_dir) {
        ...
        error_log('Found blocks in ' . $category_name . ': ' . print_r($block_dirs, true));
        ...
        foreach ($block_dirs as $block_dir) {
            ...
            if (file_exists($block_file)) {
                ...
                error_log('Block file not found: ' . $block_file);
            }
        }
    }
}
