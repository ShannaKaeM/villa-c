...
require_once get_template_directory() . '/config/compile_helpers.php';
require_once get_template_directory() . '/config/timber/paths.php';
...
{
    $blocks_dir = get_template_directory() . '/carbon-blocks/';
...
// Register Carbon Blocks after Carbon Fields is ready
